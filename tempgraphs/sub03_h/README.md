# SUB03_H: complete graphs with provisional segmentation

Sub03_H: Amit_1 and Amit_21. Amit_1 begins with an unmatched pulse at master time 274.21 seconds, followed by the first plausible pair at 530.25/549.20 seconds. Local interval 01 retains the unmatched 256.03-second context as UNKNOWN; the paired intervals start at local interval 02. This is not evidence of a 256-second protocol trial. Amit_21 also has a missing left-insole end pulse.
...
python -B generate_subjects01_to04.py --subject Sub03_H

Verify:
python -B generate_subjects01_to04.py --subject Sub03_H --verify
