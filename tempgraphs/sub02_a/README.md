# SUB02_A: complete graphs with provisional segmentation

Sub02_A: vipin_1 and vipin_21. Kept separate from Sub02_H.
...
python -B generate_subjects01_to04.py --subject Sub02_A

Verify:
python -B generate_subjects01_to04.py --subject Sub02_A --verify
