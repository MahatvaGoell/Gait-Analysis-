# SUB02_H: complete graphs with provisional segmentation

Sub02_H: Alif_1, Alif_21 and Alif_30. The Alif_21 left insole lacks its final end pulse; aligned master-clock boundaries retain that interval.
...
python -B generate_subjects01_to04.py --subject Sub02_H

Verify:
python -B generate_subjects01_to04.py --subject Sub02_H --verify
